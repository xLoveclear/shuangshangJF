		...
		<div class="col-xs-12">
			<form class="form-horizontal" id="stuForm"  role="form">
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="hidden" name="zhuangtai" id="zhuangtai" value="${yhh.zhuangtai}">
									<input type="text" name="mingcheng" id="mingcheng" value="${yhh.mingcheng}" placeholder="名称" class="col-xs-10 col-sm-5" />
								</div>
							</div>
					...
					<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" name="shangji" id="shangji" value="${yhh.shangji}" placeholder="shangji " class="col-xs-10 col-sm-5" />
								</div>
							</div>
					<div class="space-4"></div>
					...
					<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" name="id" id="id" placeholder="id" value="${yhh.id}" class="col-xs-10 col-sm-5" />
								</div>
							</div>
					<div class="space-4"></div>
		...
		$(function(){
			$("#subBtn").click(function(){
				var json1=getFrom("#stuForm");
					$.post("${jpath}/yhhangye",json1,function(data){
						console.log(data);

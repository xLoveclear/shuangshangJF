...
<script type="text/javascript">
	...
	$("#xwlm").click(function(){
			window.location.href="${jpath}/shenhecp";
		})
	...
	function editThis(id){
		...
		if(con==true){
			window.location.href="${jpath}/testChanping?id="+id;
		}
	}
	function delThis(id){
	...
	function Loadtbl(nowpageNum,nowpageSize){
				$.post("${jpath}/Chanpingfindbypage",{pageNum:nowpageNum,pageSize:nowpageSize},function(data){
